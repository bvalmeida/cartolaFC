...
import (
	...
	"github.com/bvalmeida/imersao10-consolidacao/internal/domain/entity"
	"github.com/bvalmeida/imersao10-consolidacao/internal/infra/repository"
	"github.com/bvalmeida/imersao10-consolidacao/pkg"
)
...
func (a *AddPlayerUseCase) getPlayerRepository(ctx context.Context) repository.PlayerRepository {
	playerRepository, err := a.Uow.GetRepository(ctx, "PlayerRepository")
	if err != nil {
		panic(err)
	}
	return playerRepository.(repository.PlayerRepository)
}